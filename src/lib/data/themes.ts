...
// CSS file (static/themes/<id>.css) that styles every Lily component class
// hook — see ThemePicker.svelte, which lazy-loads exactly one of these per
// selection rather than bundling all 45 up front.
...
export const themes: ThemeOption[] = [
	...
	{
		id: 'united-kingdom-national-health-service-england-for-practitioners',
		label: 'NHS England — practitioners',
		group: 'Government & healthcare'
	},
	{
		id: 'united-kingdom-national-health-service-england-for-patients',
		label: 'NHS England — patients',
		group: 'Government & healthcare'
	},
	{
		id: 'united-kingdom-national-health-service-scotland-for-practitioners',
		label: 'NHS Scotland — practitioners',
		group: 'Government & healthcare'
	},
	{
		id: 'united-kingdom-national-health-service-scotland-for-patients',
		label: 'NHS Scotland — patients',
		group: 'Government & healthcare'
	},
	{
		id: 'united-kingdom-national-health-service-wales-for-practitioners',
		label: 'NHS Wales — practitioners',
		group: 'Government & healthcare'
	},
	{
		id: 'united-kingdom-national-health-service-wales-for-patients',
		label: 'NHS Wales — patients',
		group: 'Government & healthcare'
	},
