...
// SITE_URL is the custom domain (see static/CNAME) served by GitHub
// Pages — used to build absolute URLs for canonical links, Open Graph
// tags, and the sitemap, which all require full URLs rather than
// relative paths.
